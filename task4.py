...
for i in range(int(1 / h + 1)):
    ...
    if i == 0:
        ...
        y1Arr.append(y1Arr[i - 1] + h * first(x1Arr[i - 1] + h / 2, y1Arr[i - 1] + (h / 2) * first(x1Arr[i - 1], y1Arr[i - 1])))
        y2Arr.append(y2Arr[i - 1] + h * second(x2Arr[i - 1] + h / 2, y2Arr[i - 1] + (h / 2) * second(x2Arr[i - 1], y2Arr[i - 1])))
        y3Arr.append(y3Arr[i - 1] + h * third(x3Arr[i - 1] + h / 2, y3Arr[i - 1] + (h / 2) * third(x3Arr[i - 1], y3Arr[i - 1])))
        y4Arr.append(y4Arr[i - 1] + h * forth(x4Arr[i - 1] + h / 2, y4Arr[i - 1] + (h / 2) * forth(x4Arr[i - 1], y4Arr[i - 1])))
